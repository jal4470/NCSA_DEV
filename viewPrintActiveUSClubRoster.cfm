...
<cfif team_id NEQ "">
	...
	<cfquery datasource="#application.dsn#" name="qGetGames">
		select m.roster_id, g.game_id,g.home_team_id, g.visitor_team_id, game_datetime,  game_code, field_Id, field, visitor_teamname, home_teamname, dbo.f_getTeamRoster( g.visitor_team_id) as visitor_roster_id, dbo.f_getTeamRoster(g.home_team_id) as home_roster_id
		from v_games_all g
		left join tbl_roster m
		on m.team_id=<cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#team_id#">
		where 
...
<div id="contentText">
<H1 class="pageheading">NCSA - View/Print Active US Club Roster</H1>
<br> <!--- <h2>yyyyyy </h2> --->
...
<cfif not isdefined("game_id")>
	...
	<CFIF isDefined("qGetGames") AND qGetGames.RECORDCOUNT>
		...
		<div class="notice">
			To view Roster click on View/Print next to the desired Team.
		</div>
		<div>
			<span>Working with: #getTeamInfo.teamname#</span> <a href="viewPrintActiveUSClubRoster.cfm">Select a New Team</a>
				...
				<tr>
					...
					<td style="text-align:center;">
						<cfif home_roster_id NEQ "">
							<a target="_blank" href="rosterView.cfm?roster_id=#home_roster_id#">View/Print</a><!--- |
...
<!--- 					<td style="text-align:center;">#score_home#&nbsp;</td>
					...
					<td style="text-align:center;">
						<cfif visitor_roster_id NEQ "">
							<a target="_blank" href="rosterView.cfm?roster_id=#visitor_roster_id#">View/Print</a><!--- 
							<a  href="removeRoster.cfm?roster_id=#home_roster_id#&team_id=#team_id#">Remove</a> --->
						<cfelse>
...
<cfelse>
	...
	<form action="#cgi.script_name#" method="post" onSubmit="return validatePlayUp();">
...
<cfset error = "">
	...
	<cfif contactTeams.recordcount gte 1>
		<cfloop query="contactTeams">
			<cfif isdefined("form.team_id") and form.team_id eq contactTeams.team_id>
				<cfset team_id=contactTeams.team_id>
			</cfif>
		</cfloop>
	<cfelseif contactTeams.recordcount eq 1>
		<cfset team_id=contactTeams.team_id>
	</cfif>
		...
		<table class="table1" cellpadding="3" cellspacing="0" border="0">
			...
			<cfloop query="getTeamInfo">
				<tr>
					...
					<td style="text-align:center;">
						<cfif roster_id NEQ "">
							<a target="_blank" href="rosterView.cfm?roster_id=#getTeamInfo.roster_id#">View</a>
						</cfif>
					</td>
