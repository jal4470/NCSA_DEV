  ...
  <div class="container">
    <ul class="slider_content bxslider">
      <li class="slider_item">
        <img src="assets/images/soccer_family.jpg">
        <span class="slider_title">Welcome to the Parents Sideline</span>
      </li>
    </ul>
...
<section id="parents_content" class="content_container">
