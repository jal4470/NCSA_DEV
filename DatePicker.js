...
function Calendar(p_item, p_item2, p_WinCal, p_month, p_year, p_format) {
...
//		"\"><<<\/A>]</TD><TD ALIGN=center>");
	this.wwrite("<TD ALIGN=center>[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gReturnItem2 + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><<\/A>]</TD>");
//	this.wwrite("<TD ALIGN=center>[<A HREF=\"javascript:window.print();\">Print</A>]</TD>");
	this.wwriteA("<TD ALIGN=center><FONT FACE='" + fontface + "' SIZE=2><B>");
	this.wwriteA(this.gMonthName + " " + this.gYear);
	this.wwriteA("</B></td>");
	this.wwrite("<TD ALIGN=center>[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gReturnItem2 + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\">><\/A>]</TD>");
//	this.wwrite("[<A HREF=\"" +
//		"javascript:window.opener.Build(" + 
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gReturnItem2 + "', null, '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\" alt='Prev Year'><<<\/A>]</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"javascript:window.print();\">Print</A>]</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gReturnItem2 + "', null, '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\">>><\/A>]</TD></TR></TABLE><BR>");
...
Calendar.prototype.cal_data = function() {
	...
	*/
	...
	for (j=vFirstDay; j<7; j++) {
		...
		{
			vCode = vCode +	"';self.opener.document." + this.gReturnItem2 + ".value='" +
					this.getDOW(this.gYear, this.gMonth, vDay) 
		}
...
Calendar.prototype.getDOW = function(pYear, pMonth, pDay)
{
   var l_date, l_day;

   l_date = new Date(pYear, pMonth, pDay);
...
function Build(p_item, p_item2, p_month, p_year, p_format) {
	var p_WinCal = ggWinCal;
	gCal = new Calendar(p_item, p_item2, p_WinCal, p_month, p_year, p_format);
...
function show_calendar() {
	...
	*/
	...
	Build(p_item, p_item2, p_month, p_year, p_format);
}
/*
Yearly Calendar Code Starts here
*/
function show_yearly_calendar(p_item, p_item2, p_year, p_format) {
	// Load the defaults..
	...
	Build(p_item, p_item2, null, p_year, p_format);
}
