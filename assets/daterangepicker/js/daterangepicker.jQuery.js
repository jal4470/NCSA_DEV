...
jQuery.fn.daterangepicker = function(settings){
	...
	var rpPresets = (function(){
		...
		jQuery.each(options.presetRanges,function(){
			jQuery('<li class="ui-daterangepicker-'+ this.text.replace(/ /g, '') +' ui-corner-all' + (this.separator ? ' separator' : '') + '"><a href="#">'+ this.text +'</a></li>')
	...
	jQuery.fn.clickActions = function(rp, rpPickers, doneBtn){
		if(jQuery(this).is('.ui-daterangepicker-specificDate')){
			...
			//custom date range
				...
				rp.find('.range-start').datepicker('setDate', dateStart).find('.ui-datepicker-current-day')/*.trigger('click')*/;//commented out first click event trigger to onClose event can get correct date contents, 1/4/2009, b.cooper
