...
<cfsavecontent variable = "print_report">
	<cfoutput>
		<html>
			<head>
				<title>Report</title>
							...
							<tr class="tblHeading">
					 		...
					 		<CFLOOP query="getFines">
								...
								<tr bgcolor="###setRowColor(SESSION.sitevars.altColors,currentRow)#" >
									<TD class="tdUnderLine" valign="top">  #FINE_Id#					</TD>
									<TD class="tdUnderLine" valign="top">  <cfif GAME_ID GT 0>#Game_id#<cfelse>&nbsp;</cfif></TD>
									<TD class="tdUnderLine" valign="top">  
									#(Club_Name)#
										</TD>
									<TD class="tdUnderLine" valign="top">  #TeamName#	&nbsp;	</TD>
									<td class="tdUnderLine" valign="top">  #Description#				&nbsp;</TD>
									<TD class="tdUnderLine" valign="top" align=center>  #AddByUser#	&nbsp;</TD><!--- CreatedBy --->
									<TD class="tdUnderLine" valign="top" align=center>
									...
									<td class="tdUnderLine" valign="top" align=right> $#fineAmount#</TD>
									<td class="tdUnderLine" valign="top" align=center> #StatusText#</TD>
									<cfif  len(trim(Comments))>
...
<!--- <Cfdump var="#print_report#" abort="true"> --->
<cfheader name="Content-Disposition" 
value="inline; filename=rptFinesListAll.xls">

<cfcontent type="application/xls">
<cfoutput>#print_report#</cfoutput>