<!--- 
	FileName:	rptPreGameIssuesField.cfm
...
<H1 class="pageheading">NCSA - Pre-Game Issues Field</H1>
...
select fta.*, dbo.getTeamName(fta.team_id) as team_name, 
		dbo.f_get_contact_fullname(fta.ref_id) as ref_name, dbo.f_get_division(fta.team_id) as division from (
			select g.value as game_id, q1.value as inspect_field,
		q2.value as inspect_markings, q3.value as inspect_equipment,
		gg.field, gg.game_datetime, t.value as team_id, r.value as ref_id
		from dbo.f_get_choice_responses(69,53) g
		left join dbo.f_get_responses(2,2) q1
		on g.response_id=q1.response_id
		left join dbo.f_get_responses(3,2) q2
		on g.response_id=q2.response_id
		left join dbo.f_get_responses(4,2) q3
		...
		group by g.value, q1.value, q2.value, q3.value,
...
<FORM name="Games" action="rptPreGameIssuesField.cfm"  method="post">
...
<div id="sortLinks" style="font-size:10px; margin:0 0 10px;">
	...
	<table id="resultTable" cellspacing="0" cellpadding="3" border="0" width="100%" class="table1">
		...
		<tr>
			...
			<th>Inspect Field</th>
			<th>Inspect Markings</th>
			<th>Inspect Equipment</th>
			<th>Referee</th>
		</TR>
		</thead>
		<tbody>
	<cfif getResults.recordCount GT 0>
		<cfloop query="getResults">
			<tr>
				...
				<td>#team_name#</td>
				<td>#inspect_field#</td>
				<td>#inspect_markings#</td>
				<td>#inspect_equipment#</td>
				<td>#ref_name#</td>
			</tr>
		</cfloop>
	<cfelse>
