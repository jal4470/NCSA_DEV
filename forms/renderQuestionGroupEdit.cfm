...
<cfset question_group_form_section_id = attributes.question_group_form_section_id>
...
<!--- key="#question_group_form_section_id#-#question_id#-#choice_id#" --->	
					...
					<span class="choices">
						...
						<cfset key="#question_group_form_section_id#-#question_id#-#choice_id#">
							<cfswitch expression="#choice_type_id#">
								...
								<cfcase value="3">
									<span class="choice">#name#: <input type="Radio" name="choice_#attributes.question_group_form_section_id#_#question_id#" value="#choice_id#" <cfif StructKeyExists(stResponse,key) EQ true> checked</cfif>></span>
								</cfcase>
								<cfcase value="4,5" delimiters=",">
									<option value="#choice_id#"<cfif StructKeyExists(stResponse,key) EQ true> selected</cfif>>#name#</option>
								</cfcase>
								<cfcase value="6">
									<textarea name="choice_#attributes.question_group_form_section_id#_#question_id#_#choice_id#"><cfif StructKeyExists(stResponse,key) EQ true>#stResponse[key][1]#</cfif></textarea>
								</cfcase>
								<cfcase value="7">
							...
							<cfset key="#question_group_form_section_id#-#question_id#-#choice_id#">
								<td>
									<cfswitch expression="#choice_type_id#">
										...
										<cfcase value="3">
											<input type="Radio" name="choice_#attributes.question_group_form_section_id#_#question_id#" value="#choice_id#"<cfif StructKeyExists(stResponse,key) EQ true> checked</cfif>>
										</cfcase>
										<cfcase value="4,5" delimiters=",">
										...
										<cfcase value="10">
											<cftry>
												<span class="choice label">#strReponse[key]#</span>
												<cfcatch></cfcatch>
											</cftry>
										</cfcase>
									</cfswitch>
				...
				<cfloop query="choices">
					...
					<cfswitch expression="#choice_type_id#">
						<cfcase value="11">
							<!--- text --->
							<cftry>
								<cfset choiceText=stResponse[key][1]>
