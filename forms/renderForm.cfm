...
<cfoutput>
	...
	<div class="userForm">
		<form method="post" action="<cfoutput>#Application.sitevars.homehttp#</cfoutput>/forms/form_action.cfm">
			...
			<cfloop query="formSections">
				...
				<div id="formSection#form_section_id#" class="formSection <cfif name EQ "">noName</cfif>">
					...
					<cfloop query="questionGroups">
						<cf_renderQuestionGroup question_group_form_section_id="#question_group_form_section_id#">
					</cfloop>
				</div>
			</cfloop>
