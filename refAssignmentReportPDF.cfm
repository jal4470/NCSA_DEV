...
<!--- <CFIF IsDefined("qGames")> --->
	...
	<CFIF rptType EQ "pdf">
		<tr bgcolor="##CCE4F1"><!--- <CFIF rptType EQ "csv">
				<td colspan="15"> 
			<CFELSE> --->
				<td class="tdUnderLine" colspan="7" align="center"> 
			<!--- </CFIF> --->
				Total number of Games on #dateFormat(holdDate,"mm/dd/yyyy")# = #RecCountDate#
			</td>
		</tr>
...
<!--- <cfdump var="#printerFriendlyData#"><CFABORT> --->

	<CFIF rptType EQ "csv">
			<cfheader name="Content-Disposition" value="filename=refereeAssignment.xls">
			<cfcontent type="application/vnd.ms-excel"> 
			 <cfoutput>#printerFriendlyData#</cfoutput>
			</cfcontent>
	<CFELSE>
			<!--- FOR PDF --->	
			...
			<cfoutput>
				<cfhtmlhead text="<link rel='STYLESHEET' type='text/css' href='2col_leftNav.css'>">	
				    <cfdocumentitem type="header">
	    				<cfoutput>
							<table><tr><td><br><b>Games Ref Assignment Schedule</b></td></tr></table> 
						</cfoutput>
	    			</cfdocumentitem>
				    <cfdocumentitem type="footer">
				   		<cfoutput>
						
							<table><tr><td>Page #cfdocument.currentpagenumber# of #cfdocument.totalpagecount#</td></tr></table>
						</cfoutput>
				    </cfdocumentitem>
				#printerFriendlyData#
				</cfoutput> 
