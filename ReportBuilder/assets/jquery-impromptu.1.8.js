 ...
 */
jQuery.extend({	
	ImpromptuDefaults: { prefix:'jqi', buttons:{ Ok:true }, loaded:function(){}, submit:function(){return true;}, callback:function(){}, opacity:0.3, zIndex: 999, overlayspeed:'slow', promptspeed:'fast', show:'fadeIn', focus:0, useiframe:false, top: '100px', persistent: true, width: 'auto' },
	...
	prompt: function(m,o){
		...
		var positionPrompt = function(){
			...
			jqi.css({ position: "absolute", left: "50%", width: o.width, marginLeft: ((((jqi.css("paddingLeft").split("px")[0]*1) + jqi.width())/2)*-1) });
		};
