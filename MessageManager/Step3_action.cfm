...
<CFIF opcnt NEQ clcnt>
	<cfmodule template="error.cfm"  error="Your message cannot contain < or >.">
</CFIF>
...
<!--------------------->
<cfif error NEQ "">
	<cfmodule template="error.cfm" error="Please fix the following errors:<ul>#error#</ul>">
</cfif>
...
<!--- Redirect --->
<!---------------->
<cflocation url="#next_page#?message_id=#message_id#&report_id=#url.report_id#" addtoken="no">
