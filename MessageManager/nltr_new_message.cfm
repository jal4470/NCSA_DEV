		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						<td width="402" align="left" valign="middle" style="background-image: url(assets/images/emailbuttons_no_sp.jpg);background-repeat: no-repeat;height:28px;">
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								...
								<td width="72" align="left" valign="middle"><input type="button" name="submit" value="Preview" class="emailprevbut" onclick="javascript:tinyMCE.execInstanceCommand('mceEditorArea','mcePreview')"></td>
								<td width="118" align="left" valign="middle"><img src="assets/images/spcrimg.gif" alt="" width="1" height="3" border="0"></td>
							</tr>
						</table>
						</td>
			...
			<tr>
				...
				<input type="hidden" name="cc_emails" value="#cc_emails#">
				<input type="hidden" name="bcc_emails" value="#bcc_emails#">
				<input type="hidden" name="replyto_email_address" value="#replyto_email_address#">
				<input type="hidden" name="replyto_email_alias" value="#replyto_email_alias#">
				...
				<table border="0" cellspacing="2" cellpadding="2" width="100%">
					...
					<tr>
						...
						<TEXTAREA ID="Text1" COLS="" ROWS="1" style="overflow: visible" ONKEYDOWN="expandTextArea(this, event);" class="emailtofield" name="emailto" ReadOnly="True" onClick="toggleBox('demodiv',1); vis('visible');">#variables.email_to_string#</TEXTAREA>
</td>
					</tr>
					<tr>
						<td class="emailproplabel">From Email:</td>
						<td class="emailpropitem"><input type="text" name="from_email_address" size="40" maxlength="100" class="emailpropfield" value="#from_email_address#"></td>
					</tr>
					<tr>
...
<!--- Commented out 12/9/09 PW
					<tr>
						<td class="emailproplabel">Track Opens:</td>
						<td class="emailpropitem" align="left"><input type="checkbox" name="track_opens_flag" value="1"<CFIF track_opens EQ 1> CHECKED</CFIF>></td>
					</tr>
--->
					<tr>
						<td colspan="2"><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
