...
<cfelse>
	<cfoutput>ERROR,76009,'Required parameter form_question_choice_id not supplied.'</cfoutput><cfabort>	
</cfif>
...
<cftry>
	<CFSTOREDPROC datasource="#dsn#" procedure="p_update_newsletter_topic" returncode="YES" >
