...
<cfsavecontent variable="arrows">
	<cfoutput>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="58">
			<tr>
		...
		<cfset prev_start	= rs.start_record - rs.records_per_page>
		<cfset prev_end		= rs.end_record - rs.records_per_page>
		<cfset jump_beg_start = 1>
		<cfset jump_beg_end = rs.records_per_page>
				<td width="13"><a href="#cgi.script_name#?start_record=#jump_beg_start#&end_record=#jump_beg_end#&total_records=#rs.total_records#&records_per_page=#rs.records_per_page#&#variables.query_str#" class="basenavlink"><img src="assets/images/but_em_jump_left.gif" alt="" width="13" height="16" border="0"></a></td>
				<td width="11"><a href="#cgi.script_name#?start_record=#prev_start#&end_record=#prev_end#&total_records=#rs.total_records#&records_per_page=#rs.records_per_page#&#variables.query_str#" class="basenavlink"><img src="assets/images/but_em_left.gif" alt="" width="11" height="16" border="0"></a></td>
		<CFELSE>
				<td width="13"><img src="assets/images/but_em_jump_left.gif" alt="" width="13" height="16" border="0"></td>
				<td width="11"><img src="assets/images/but_em_left.gif" alt="" width="11" height="16" border="0"></td>
		</CFIF>
		...
		<CFIF rs.end_record lt rs.total_records>
				...
				<cfset next_start	= rs.start_record + rs.records_per_page>
				<cfset next_end		= rs.end_record + rs.records_per_page>
				<td width="12"><a href="#cgi.script_name#?start_record=#next_start#&end_record=#next_end#&total_records=#rs.total_records#&records_per_page=#rs.records_per_page#&#variables.query_str#" class="basenavlink"><img src="assets/images/but_em_right.gif" alt="" width="12" height="16" border="0"></a></td>
		<CFELSE>
				<td width="12"><img src="assets/images/but_em_right.gif" alt="" width="12" height="16" border="0"></td>
		</CFIF>
		...
		<cfloop from="#from_page#" to="#to_page#" index="this_page">
			...
			<cfset last_record	= last_record - rs.records_per_page>
				...
				<td width="12"><a href="#cgi.script_name#?start_record=#first_record#&end_record=#last_record#&total_records=#rs.total_records#&records_per_page=#rs.records_per_page#&#variables.query_str#" class="basenavlink"><img src="assets/images/but_em_jump_right.gif" alt="" width="12" height="16" border="0"></a></td>
				<td width="10"><img src="assets/images/spcrimg.gif" alt="" width="10" height="16" border="0"></td>
			</tr>
		</table>
