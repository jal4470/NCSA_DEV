...
<CFSET new_sub_image = "#orgsignup.new_sub_asset_id#">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="350" align="left" valign="middle" class="bartitle">Administration - New Subscriber Sign-Up Instructions</td>
							</tr>
						</table>
						</td>
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="4" width="100%">
					<CFOUTPUT>
					<form method="post" action="nltr_control_signup_action.cfm?s=#securestring#" ENCTYPE="multipart/form-data">
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="15" border="0"></td>
					</tr>
					<tr>
						<td class="formitemlabelwhfull" valign="top" style="padding-left:20px;">New Subscriber Sign-Up Form Image:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><input type="file" name="new_sub_image" class="imagefield" size="30" value="#new_sub_image#"> <CFIF new_sub_image IS NOT ""><a href="javascript:popupimage('#new_sub_image#')" class="formlink">View Current</a></CFIF></td>
					</tr>
					<CFIF new_sub_image IS NOT "">
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><input type="checkbox" name="new_sub_image_remove" value="1"> Remove Current Image</td>
					</tr>
					</CFIF>
					<tr>
					...
					<tr>
						<td class="formitemlabelwhfull" valign="top" style="padding-left:20px;">New Subscriber Sign-Up Instructions:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><textarea name="new_sub_account_add_instructions" class="mceEditor" style="width:700px;height:150px;">#new_sub_account_add_instructions#</textarea></td>
					</tr>
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
					</tr>
					<tr>
						<td class="formitemlabelwhfull" valign="top" style="padding-left:20px;">New Subscriber Select Topic Instructions:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><textarea name="new_sub_message" class="mceEditor" style="width:700px;height:150px;">#new_sub_message#</textarea></td>
					</tr>
					<tr>
