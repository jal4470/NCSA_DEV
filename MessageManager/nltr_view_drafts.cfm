...
<CFTRY>
	<CFINVOKE component="API.getMessage" method="GetDraftMessages" returnvariable="getdrafts">
	</CFINVOKE>
	<CFCATCH type="any">
		<cfdump var="#cfcatch#">		
	</CFCATCH>			
...
function doConfirmation(message_id){
	gostring = "<CFOUTPUT>nltr_cancel_action.cfm?nextpage=nltr_view_drafts.cfm&message_id=</CFOUTPUT>" + message_id;
...
<table border="0" cellspacing="0" cellpadding="2" width="100%">
	<tr>
		...
		<!--- LEFT NAVIGATION --->
		<!--- <CF_nltr_navigation securestring="#securestring#" location="drafts" organization_id="#organization_id#" rolelistStr="#rolelistStr#">
		 --->
		</td>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<CFOUTPUT>
					<form method="post" action="nltr_new_message.cfm">
					<tr>
						...
						<td width="80" align="left" valign="middle" class="controlbartext" onclick="location.href='nltr_admin.cfm'">Administration</td>
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%">
					...
					<tr onmouseout="scbg(this, 0);" onmouseover="scbg(this, 1);">
						<td class="blankrowitem" onclick="location.href='nltr_new_message.cfm?message_id=#message_id#'">#message_desc#</td>
						<td class="blankrowitem" onclick="location.href='nltr_new_message.cfm?message_id=#message_id#'">#from_email_address#</td>
						<td class="blankrowitem" onclick="location.href='nltr_new_message.cfm?message_id=#message_id#'">#DATEFORMAT(datecreated,"MM/DD/YYYY")# - #TIMEFORMAT(datecreated,"h:mm tt")#</td>
						<td class="blankrowitem" onclick="location.href='nltr_new_message.cfm?message_id=#message_id#'">owner</td>
