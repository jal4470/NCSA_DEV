...
3-14-2011 J. Lechuga Reformatted Message to include recipient metrics.
...
<CFTRY>
	<CFINVOKE component="#application.MM_API_Path#GetMessage" method="GetMessageDetail" returnvariable="GetMessage">
		<cfinvokeargument name="message_id" value="#message_id#">
	</CFINVOKE>
	<CFCATCH type="any">
			<cfdump var="#cfcatch#"><cfabort>	
...
<!--- <Cfdirectory action="LIST" directory="#ExpandPath('/MessageManager')#" name="dir">
<cfdump var="#dir#"> --->
<!---
				...
				<table border="0" cellspacing="2" cellpadding="2" width="100%">
					<tr>
						...
						<table border="0" cellspacing="2" cellpadding="2" >
							...
							<tr>
								<td valign="top" width="150" align="right">To:</td>
								<td >
								<textarea cols="40" rows="5" wrap="hard" readonly ><cfloop list="#toString#" index="i" delimiters=";">#trim(i)##chr(10)#</cfloop></textarea>
								
								</td>
							</tr>
							<tr>
								<td  align="right">Replyto Email:</td>
								<td >#replyto_email_address#</td>
							</tr>
							<tr>
								<td  align="right">Replyto Name:</td>
								<td >#replyto_email_alias#</td>
							</tr>
							<tr>
						...
						<table border="0" cellspacing="2" cellpadding="2">
							...
							<tr>
								<td valign="top" width="150"  align="right">Recipients:</td>
								<td align="right" nowrap>#NumberFormat(getMessage.recipient_cnt)#</td>
								<td >&nbsp;</td>
							</tr>
							<cfif getMessage.msg_transmission_status_id EQ 1>
							<tr>
								<td  align="right">Bounced:</td>
								<td >
								<cfif getMessage.bounced_cnt eq 0 >
								#NumberFormat(getMessage.bounced_cnt)#
								<cfelse>
								<a href="/MessageManager/extractBounces.cfm?message_id=#message_id#">#NumberFormat(getMessage.bounced_cnt)#</a>
								</cfif>
								</td>
								<td class="emailpropitem" align="right" nowrap><cfif getMessage.recipient_cnt> #DecimalFormat((getMessage.bounced_cnt/getMessage.recipient_cnt)*100)#%<cfelse>N/A</cfif></td>
							</tr>
							<tr>
								<td align="right" nowrap>Delivered:</td>
								<td>#NumberFormat(getMessage.delivered_cnt)#</td>
								<td ><cfif getMessage.recipient_cnt> #DecimalFormat((getMessage.delivered_cnt/getMessage.recipient_cnt)*100)#%<cfelse>N/A</cfif></td>
							</tr>
							<tr>
								<td align="right">Opened:</td>
								<td>#NumberFormat(getMessage.opened_cnt)#</td>
								<td><cfif getMessage.recipient_cnt>#DecimalFormat((getMessage.opened_cnt/getMessage.recipient_cnt)*100)#%<cfelse>N/A</cfif></td>
							</tr>
							</cfif>
							<tr>
								<td colspan="3"><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
							</tr>
						</table>
						</td>
						...
						<table border="0" cellspacing="2" cellpadding="2">
							...
							<cfif getMessage.msg_transmission_status_id EQ -1>
							<tr>
								<td valign="top" align="right">Sent Date:</td>
								<td align="left">#DateFormat(getMessage.sent_date,'mm/dd/yyyy')# #TimeFormat(getMessage.sent_date,'h:mm tt')#</td>
							</tr>
							<cfelseif getMessage.msg_transmission_status_id EQ 0>
							<tr>
								<td valign="top" align="right">Scheduled Date:</td>
								<td  align="left">#DateFormat(getMessage.scheduled_date,'mm/dd/yyyy')# #TimeFormat(getMessage.scheduled_date,'h:mm tt')#</td>
							</tr>
							<cfelseif getMessage.msg_transmission_status_id EQ 1>
							<tr>
								<td  valign="top" align="right">Sent Date:</td>
								<td class="emailpropitem" align="left">#DateFormat(getMessage.sent_date,'mm/dd/yyyy')# #TimeFormat(getMessage.sent_date,'h:mm tt')#</td>
							</tr>
							</cfif>

							<!-- Transmit Status --->
							<tr>
								<td  valign="top" align="right">Transmit Status:</td>
								<td  align="left">#getMessage.msg_transmission_status_desc#</td>
							</tr>

							<cfif getMessage.msg_transmission_status_id EQ -1>
							<tr>
								<td valign="top" align="right">Failed Date:</td>
								<td align="left">#DateFormat(getMessage.dateupdated,'mm/dd/yyyy')# #TimeFormat(getMessage.dateupdated,'h:mm tt')#</td>
							</tr>
							<cfelseif getMessage.msg_transmission_status_id EQ 1>
							<tr>
								<td valign="top" align="right">Confirmed Date:</td>
								<td align="left">#DateFormat(getMessage.confirmed_date,'mm/dd/yyyy')# #TimeFormat(getMessage.confirmed_date,'h:mm tt')#</td>
							</tr>
							</cfif>
							<tr>
								<td  valign="top" align="right">Distribution List:</td>
								<td  align="left">#getMessage.distribution_list#</td>
							</tr>
