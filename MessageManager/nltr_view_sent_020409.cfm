...
function doConfirmation(message_id){
	gostring = "<CFOUTPUT>nltr_cancel_action.cfm?s=#securestring#&nextpage=nltr_view_sent.cfm&message_id=</CFOUTPUT>" + message_id;
...
<table border="0" cellspacing="0" cellpadding="2" width="100%">
	<tr>
		...
		<!--- LEFT NAVIGATION --->
		<CF_nltr_navigation securestring="#securestring#" location="sent" organization_id="#organization_id#" rolelistStr="#rolelistStr#">
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%">
					...
					<tr onmouseout="scbg(this, 0);" onmouseover="scbg(this, 1);">
						<td class="blankrowitem" onclick="location.href='nltr_view_sent_message.cfm?s=#securestring#&message_id=#message_id#'">#message_desc#</td>
						<td class="blankrowitem" onclick="location.href='nltr_view_sent_message.cfm?s=#securestring#&message_id=#message_id#'"><CFIF confirmed_date IS "">Sent...<CFELSE>Transmitted</CFIF></td>
						<td class="blankrowitem" onclick="location.href='nltr_view_sent_message.cfm?s=#securestring#&message_id=#message_id#'">#from_email_address#</td>
						<td class="blankrowitem" onclick="location.href='nltr_view_sent_message.cfm?s=#securestring#&message_id=#message_id#'">#DATEFORMAT(datecreated,"MM/DD/YYYY")# - #TIMEFORMAT(datecreated,"h:mm tt")#</td>
						<td class="blankrowitem" onclick="location.href='nltr_view_sent_message.cfm?s=#securestring#&message_id=#message_id#'">owner</td>
