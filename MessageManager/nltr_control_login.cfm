		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="250" align="left" valign="middle" class="bartitle">Administration - Login Instructions</td>
							</tr>
						</table>
						</td>
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="4" width="100%">
					<CFOUTPUT>
					<form method="post" action="nltr_control_login_action.cfm?s=#securestring#" ENCTYPE="multipart/form-data">
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="15" border="0"></td>
					</tr>
					<tr>
						<td class="formitemlabelwhfull" valign="top" style="padding-left:20px;">New Subscriber:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><textarea name="new_sub_login_instructions" class="mceEditor" style="width:700px;height:150px;">#new_sub_login_instructions#</textarea></td>
					</tr>
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
					</tr>
					<tr>
						<td class="formitemlabelwhfull" valign="top" style="padding-left:20px;">Returning Subscriber:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><textarea name="ret_sub_login_instructions" class="mceEditor" style="width:700px;height:150px;">#ret_sub_login_instructions#</textarea></td>
					</tr>
					<tr>
