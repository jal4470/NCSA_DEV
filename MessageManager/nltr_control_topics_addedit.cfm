...
<!---------------->
<!--- Edit topic --->
<cfif form_question_choice_id NEQ "">
<cftry>
	<cfquery name="getTopic" datasource="#dsn#">
	SELECT CHOICE_SHORT_DESC AS TOPIC_SHORT_DESC,
	       CHOICE_DESCRIPTION AS TOPIC_DESCRIPTION,
	       STATUS_ID AS TOPIC_STATUS_ID
	  FROM V_FORM_QUESTION_CHOICES
	 WHERE FORM_QUESTION_CHOICE_ID = <CFQUERYPARAM VALUE="#FORM_QUESTION_CHOICE_ID#">
	</cfquery>

	<cfset topic_short_desc = getTopic.topic_short_desc>
	<cfset topic_description = getTopic.topic_description>
	<cfset topic_status_id = getTopic.topic_status_id>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="4" width="100%">
					<CFOUTPUT>
					<form method="post" action="nltr_control_topics_addedit_action.cfm?s=#securestring#" ENCTYPE="multipart/form-data">
					...
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><input type="text" name="topic_short_desc" size="100" maxlength="500" class="widefield" value="#topic_short_desc#"></td>
					</tr>
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
					</tr>
					...
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><textarea name="topic_description" class="mceEditor" style="width:700px;height:150px;">#topic_description#</textarea></td>
					</tr>
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="1" border="0"></td>
					</tr>
					<tr>
						<td class="formitemlabelwhfull" valign="bottom" style="padding-left:20px;">Active:<img src="assets/icons/ques3.gif" alt="" width="21" height="17" border="0" style="vertical-align: bottom"><input type="checkbox" name="topic_status_id" value="1"<cfif topic_status_id EQ 1> CHECKED</cfif>></td>
					</tr>
					<tr>
						<td><img src="assets/images/spcrimg.gif" alt="" width="1" height="5" border="0"></td>
					</tr>
					<tr>
						<td class="formitemwh" style="padding-left:20px;"><img src="assets/images/but_email_cancel.gif"  width="72" height="17" onclick="location.href='nltr_control_topics.cfm?s=#securestring#'" border="0" style="cursor: pointer;"> 
