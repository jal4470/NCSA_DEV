...
<cfoutput>
<div id="contentText">
<H1 class="pageheading">NCSA - New Club DELETE Application</H1>
<h2>Club: #ClubDetails.club# </h2> 
<br>	
<span class="red">Are you sure you want to DELETE this application?</span>
...
<CFIF isDefined("FORM.DELETE")>
	...
	<CFQUERY name="qUpdClubRegReq" datasource="#SESSION.DSN#">
		DELETE FROM TBL_ClubRegRequest
...
<form action="regNewClubDelete.cfm" method="post">
