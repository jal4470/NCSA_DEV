...
<cfquery datasource="#application.dsn#" name="getGame">
	...
	from dbo.f_get_choice_responses(69,53) r
	inner join dbo.f_get_choice_responses(70,53) r2
	on r.response_id=r2.response_id
	inner join v_games_all g
	on r.value=g.game_id
...
window.onload = function () {
		document.getElementById("btnEdit").onclick = function () {
			window.location = "matchEvaluationEdit.cfm?response_id=#response_id#";
		};
		document.getElementById("btnDelete").onclick = function () {
			if (confirm("Are you sure you want to delete this submission?"))
				window.location = "matchEvaluationDelete.cfm?response_id=#response_id#&team_id=#getGame.team_id#&btnDelete=true";
		};
	};
</script>
<style>
...
<div id="contentText">
<H1 class="pageheading">NCSA - View Match Evaluation</H1>
<br> <!--- <h2>yyyyyy </h2> --->
